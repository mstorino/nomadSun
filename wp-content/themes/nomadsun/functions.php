...
if ( defined( 'JETPACK__VERSION' ) ) {
	...
	// and an input of name, name = var which represents whatever data we put into function
...
//write a function that formats date in nice way
//$date represents whatever is passed into function
...
// function to return
// nicely  formatted bg img
//join static text to var aka string concatination 
//pass in image_field and it returns us it
//in a formattted fashion
