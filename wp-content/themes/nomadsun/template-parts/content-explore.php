<div class="container center ph4-l mb5 mb6-l">
    ...
    <div class="flex-ns flex-wrap justify-between ">
        ...
        'posts_per_page' => 3,
        'orderby' => 'rand',
        //here we make sure to exclude current post
        //similar to post['id']
        ...
        <a href="<?php the_permalink()?>" class="db link w-100 w-third-ns ph3 mb3 mb0-ns">
            <!-- here we create 1x1 aspect ratio box -->
            <div class="aspect-ratio aspect-ratio--1x1">
                <!-- our inner element takes upu the full width -->
                <div class="aspect-ratio--object center cover flex items-center justify-center ph3" style="<?php nice_background('hero_image'); ?>">
